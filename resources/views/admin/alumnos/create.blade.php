...
<div class="content">
  <div class="container-fluid">
    <div class="row">
      <div class=" col-md-12"> 
        ...
        <h4 class="card-tittle text-center"><strong>DATOS DEL ALUMNO</strong></h4>
          ...
          <div class="row" style="margin-right: 3px; margin-left: 3px;">       
            ...
            <input class="form-control" name="apellidoalumno" value="{{ old('apellidoalumno') }}">
      ...
      <br>
        ...
        </div><!--*cierra la tarjeta de alumno -->

          
  <div><!--empieza la tarjeta de familia-->
    <br>
        <u><h4 class="card-tittle text-center"><strong>DATOS DE LA FAMILIA</strong></h4></u>
        @if(session('success'))
        ...
        <div class=" col-xs-12 col-sm-12 col-md-12 text-right">
          <input type="button" class="btn btn-sm btn-facebook" id="botonalumnos" name="botonalumnos" data-toggle="modal" data-target="#myModal" value="Crear nuevo familiar">
        </div>
                  ...
                  <td class="v-align-middle">
                    <input type="checkbox" value="{{$fam->id}}" id="check" name="check" onclick="botonalumnos.disabled =this.checked"></td>
                      ...
                      <button type="button" class="close" data-dismiss="modal" title="Cerrar">&times;</button>
                        ...
                        <a href="{{ route('editarfam',$fam->id) }}" class="btn btn-warning" title="Modificar familia"><i class="bi bi-pencil"></i>
                        </td>                                      
                      @endforeach
                    </tbody>  
                  </table>
                </div> <!--cierra tarjeta familia-->
  ...
  <div class="card" style="border: thin solid lightgrey;"><!--empieza la tarjeta de familia-->
    <br>
