...
<main style="position:relative;top: 40px;">
    ...
    <p style="text-align: justify;">
        ...
        if($generoalumno=='Femenino'){
         ?>
         La alumna <strong>{{$nombrecompleto}}</strong> de <strong>{{$gradoalumno}}</strong> ha obtenido las siguientes calificaciones durante el <strong>{{$periodo}}</strong> perteneciente al año lectivo <strong>{{$descripcionaño}}</strong>. 
        <?php 
        }
        if($generoalumno=='Masculino'){
         ?>
         El alumno <strong>{{$nombrecompleto}}</strong> de <strong>{{$gradoalumno}}</strong> ha obtenido las siguientes calificaciones durante el <strong>{{$periodo}}</strong> perteneciente al año lectivo <strong>{{$descripcionaño}}</strong>. 
        <?php
        }
        ?>
    </p>
    ...
    ?>
        ...
        <th class="tabla" style="width:55%;">Observación</th>
        </thead>
        <tbody>
