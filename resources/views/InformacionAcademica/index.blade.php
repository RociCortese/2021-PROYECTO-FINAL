                ...
                <div class="table-responsive">
                  <table class="table">
                    ...
                    ?>
                      ...
                      <?php
                      if($informacionperiodo=='Bimestre'){
                      if($informaciongrado->periodo=='Primer período'){
                      $arregloB[0]=$informaciongrado->nota;
                      }
                      elseif($informaciongrado->periodo=='Segundo período'){
                      $arregloB[1]=$informaciongrado->nota; 
                      }
                      elseif($informaciongrado->periodo=='Tercer período'){
                      ...
                      $arregloC[2]=$informaciongrado->nota; 
                      }
                      }
                      if($informacionperiodo=='Semestre'){
                      if($informaciongrado->periodo=='Primer período'){
                      $arregloS[0]=$informaciongrado->nota;
                      }
                      else{
                      $arregloS[1]=$informaciongrado->nota; 
                      }
                      }
                      ?>
                      @endif
                    ...
                    if($informacionperiodo=='Semestre'){
                      ...
                      for($i=0;$i<=$contador;$i++){
                        ...
                        <?php 
                          ...
                          <td class="v-align-middle">{{$arregloS[$i]}}</td>
                        <?php
                        }
                      }
                    }
