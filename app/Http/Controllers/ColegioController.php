...
public function update(Request $request,$id)
    {
        ...
        'cue' => ['required', 'int','min:100000000','max:999999999','unique:colegio,cue,'.$id],
        ]);
        ...
        $data= $request->only('nombre', 'gestion','direccion','telefono','localidad','provincia','email','file','cue');
        $col->update($data);
